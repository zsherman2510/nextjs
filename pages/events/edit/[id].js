...
export default function EditEventPage({evt}) {
    ...
    //add image state
    //check if there is an image using tenary else its null
    //put preview under form if there is an image. else place a message saying no image.
    //add a button with icon from faimage from react icons
        ...
        <Layout title='Edit Event'>
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
                ...
                <div>
                    ...
                    <textarea type="text" id="description" name="description" className={styles.description} value={values.description} onChange={handleInputChange}></textarea>
                </div>
...
//retrieve the event you want to edit using getserversideprops. destructure the params and grab the id for the event. return the evt as a prop and pass it into the page. set the values with the evt.

//import moment and wrap the date value with moment and format it with yyyy/mm/dd
